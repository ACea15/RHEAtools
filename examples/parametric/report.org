...
#+begin_src python :session py1  :results value
  ...
  results = src.parametric_analysis.build_flutter2(file_paths, file_names, Modes=range(15), collector=collector)
...
#+begin_src python  :results raw :exports results
  flutter_speeds = [results[f'shift_conm2s_tailless{i}_0']['FlutterSpeed'] for i in [10, 15, 25, 30]]
...
#+RESULTS: FLUTTER-reference

#+NAME: VgVfreference-shift_conm2s_tailless25_0
...
#+RESULTS: VgVfreference-shift_conm2s_tailless25_0
[[file:./img/VgVfreference-shift_conm2s_tailless25_0.png]]


** Parametric lumped masses
#+NAME: FLUTTER-shift_conm2s_tailless40
#+begin_src python  :results raw :exports results
...
#+RESULTS: FLUTTER-shift_conm2s_tailless40
...
#+RESULTS: FLUTTER-shift_conm2s_tailless15
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 169.786 |            3 |      0 |
| 162.301 |            3 |  -0.05 |
...
#+RESULTS: FLUTTER-shift_conm2s_tailless10
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 164.922 |            3 |      0 |
| 158.647 |            3 |  -0.05 |
...
*** Masses shifted -0.15%
#+NAME: VgVf-shift_conm2s_tailless40_3
#+begin_src python :session py1 :results value file  :exports results 
  fig1 = f"./img/{name}.png"
  results[name.split("-")[-1]]['sol145'].obj.plot_vg_vf(modes=range(1, 25),
...
#+RESULTS: VgVf-shift_conm2s_tailless40_3
[[file:./img/VgVf-shift_conm2s_tailless40_3.png]]

#+RESULTS: VgVf-shift_conm2s_tailless15_3
[[file:./img/VgVf-shift_conm2s_tailless15_3.png]]
...
#+RESULTS: VgVf-shift_conm2s_tailless15_7
[[file:./img/VgVf-shift_conm2s_tailless15_7.png]]
...
#+RESULTS: VgVf-shift_conm2s_tailless15_9
[[file:./img/VgVf-shift_conm2s_tailless15_9.png]]


** Parametric aerodynamic placement
#+NAME: FLUTTER-shift_panels_tailless15
#+begin_src python  :results raw :exports results
  df_ = results_df[name.split("-")[-1]]
  df_ = df_.rename(columns={"xlabel": "factor"})
  df_['flutter_mode']+=1
...
#+RESULTS: FLUTTER-shift_panels_tailless15
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 172.617 |            4 |  -0.25 |
| 173.109 |            4 |   -0.2 |
...
#+RESULTS: FLUTTER-shift_panels_tailless10
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 168.873 |            3 |  -0.25 |
| 167.962 |            3 |   -0.2 |
...
#+RESULTS: FLUTTER-CHORD_EXTENSION_tailless15
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 162.387 |            5 |    0.7 |
| 152.948 |            5 |   0.85 |
...
#+RESULTS: FLUTTER-CHORD_EXTENSION_tailless10
| flutter | flutter_mode | factor |
|---------+--------------+--------|
| 159.953 |            5 |    0.7 |
| 147.295 |            5 |   0.85 |
