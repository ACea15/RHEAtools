...
#+begin_src python :session py1 :results output :var dir1=(print local_root)
...
#+NAME: FLUTTER-shift_conm2s_tailless15
...
*** Masses shifted -0.15%
#+NAME: VgVf-shift_conm2s_tailless15_3
